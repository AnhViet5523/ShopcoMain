...
} from "./chunk-QZK2ZRKU.js";
import {
  warnOnce
} from "./chunk-WCIA6SOI.js";
import {
  Chip_default,
...
function useValidation(options) {
  ...
  const previousValidationErrorRef = React5.useRef(validator2.valueManager.defaultErrorState);
...
var usePickerValue = ({
  ...
  const [previousTimezoneProp, setPreviousTimezoneProp] = React9.useState(timezoneProp);
  if (true) {
    React9.useEffect(() => {
...
var PickersLayout = React18.forwardRef(function PickersLayout2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersLayout"
  });
  ...
  return (0, import_jsx_runtime8.jsxs)(PickersLayoutRoot, {
    ...
    children: [isLandscape ? shortcuts : toolbar, isLandscape ? toolbar : shortcuts, (0, import_jsx_runtime8.jsx)(PickersLayoutContentWrapper, {
      ...
      children: wrapperVariant === "desktop" ? (0, import_jsx_runtime8.jsxs)(React18.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime8.jsxs)(React18.Fragment, {
...
var PickersContext = React19.createContext(null);
function PickersProvider(props) {
  ...
  return (0, import_jsx_runtime9.jsx)(PickersContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime9.jsx)(LocalizationProvider, {
      localeText,
      children
    })
  });
...
var useDesktopPicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime10.jsxs)(PickersProvider, {
    contextValue,
    localeText,
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime11.jsxs)(React21.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime11.jsxs)(React21.Fragment, {
  children: [(0, import_jsx_runtime11.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime11.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
var useFieldState = (params) => {
  ...
  const localizedDigits = React22.useMemo(() => getLocalizedDigits(utils), [utils]);
  const sectionsValueBoundaries = React22.useMemo(() => getSectionsBoundaries(utils, localizedDigits, timezone), [utils, localizedDigits, timezone]);
  const getSectionsFromValue = React22.useCallback((value, fallbackSections = null) => fieldValueManager.getSectionsFromValue(utils, value, fallbackSections, (date) => buildSectionsFromFormat({
    utils,
  ...
  const parsedSelectedSections = React22.useMemo(() => parseSelectedSections(selectedSections, state.sections), [selectedSections, state.sections]);
...
var useFieldV7TextField = (params) => {
  ...
  const sectionListRef = React24.useRef(null);
  ...
  const sectionBoundaries = React24.useMemo(() => {
    ...
    return state.sections.map((section, index) => {
      ...
      return {
        ...
        content: {
          ...
          [parseInt(React24.version, 10) >= 17 ? "enterKeyHint" : "enterkeyhint"]: isEditable ? "next" : void 0,
  ...
  const valueStr = React24.useMemo(() => areAllSectionsEmpty ? "" : fieldValueManager.getV7HiddenInputValueFromSections(state.sections), [areAllSectionsEmpty, state.sections, fieldValueManager]);
  React24.useEffect(() => {
...
var useFieldV6TextField = (params) => {
  const isRtl = useRtl();
  const focusTimeoutRef = React25.useRef(void 0);
  const selectionSyncTimeoutRef = React25.useRef(void 0);
  const {
    forwardedProps: {
      onFocus,
      onClick,
  ...
  const sections = React25.useMemo(() => addPositionPropertiesToSections(state.sections, localizedDigits, isRtl), [state.sections, localizedDigits, isRtl]);
  const interactions = React25.useMemo(() => ({
    syncSelectionToDOM: () => {
      if (!inputRef.current) {
        return;
      }
  ...
  const placeholder = React25.useMemo(() => {
    if (inPlaceholder !== void 0) {
      return inPlaceholder;
    }
    return fieldValueManager.getV6InputValueFromSections(getSectionsFromValue(valueManager.emptyValue), localizedDigits, isRtl);
  }, [inPlaceholder, fieldValueManager, getSectionsFromValue, valueManager.emptyValue, localizedDigits, isRtl]);
  const valueStr = React25.useMemo(() => state.tempValueStrAndroid ?? fieldValueManager.getV6InputValueFromSections(state.sections, localizedDigits, isRtl), [state.sections, fieldValueManager, state.tempValueStrAndroid, localizedDigits, isRtl]);
  React25.useEffect(() => {
  ...
  const inputMode = React25.useMemo(() => {
    if (activeSectionIndex == null) {
      return "text";
    }
...
var useField = (params) => {
  ...
  const sectionOrder = React26.useMemo(() => getSectionOrder(state.sections, isRtl && !enableAccessibleFieldDOMStructure), [state.sections, isRtl, enableAccessibleFieldDOMStructure]);
  const {
    returnedValue,
    interactions
  ...
  const inputError = React26.useMemo(() => {
    if (error !== void 0) {
      return error;
    }
  ...
  React26.useImperativeHandle(unstableFieldRef, () => ({
...
var useClearableField = (props) => {
  ...
  return _extends({}, other, {
    InputProps: _extends({}, InputProps, {
      endAdornment: (0, import_jsx_runtime12.jsxs)(React27.Fragment, {
...
var useParsedFormat = (parameters) => {
  ...
  const isRtl = useRtl();
  const translations = usePickersTranslations();
  const localizedDigits = React29.useMemo(() => getLocalizedDigits(utils), [utils]);
...
var usePickersContext = () => {
  const value = React30.useContext(PickersContext);
  if (value == null) {
...
var PickersSectionList = React31.forwardRef(function PickersSectionList2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersSectionList"
  });
  ...
  React31.useImperativeHandle(sectionListRef, () => ({
    getRoot() {
  ...
  return (0, import_jsx_runtime13.jsx)(Root, _extends({}, rootProps, {
    children: rootProps.contentEditable ? elements.map(({
      ...
      before,
      after
    }) => `${before.children}${content.children}${after.children}`).join("") : (0, import_jsx_runtime13.jsx)(React31.Fragment, {
...
var PickersOutlinedInput = React34.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime16.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime16.jsx)(Outline, {
      ...
      label: label != null && label !== "" && (muiFormControl == null ? void 0 : muiFormControl.required) ? (0, import_jsx_runtime16.jsxs)(React34.Fragment, {
        children: [label, " ", "*"]
      }) : label,
      ownerState
    })
...
function StyledEngineProvider(props) {
  ...
  const cache = React35.useMemo(() => getCache(injectFirst, enableCssLayer), [injectFirst, enableCssLayer]);
  return cache ? (0, import_jsx_runtime17.jsx)(CacheProvider, {
    value: cache,
    children
  }) : children;
}
true ? StyledEngineProvider.propTypes = {
   ...
   */
  enableCssLayer: import_prop_types9.default.bool,
  /**
...
function GlobalStyles(props) {
  ...
  return (0, import_jsx_runtime18.jsx)(Global, {
    styles: globalStyles
  });
}
...
function deepClone(source) {
  if (React37.isValidElement(source) || (0, import_react_is.isValidElementType)(source) || !isPlainObject(source)) {
    return source;
  }
  const output = {};
...
function deepmerge(target, source, options = {
  ...
  if (isPlainObject(target) && isPlainObject(source)) {
    Object.keys(source).forEach((key) => {
      if (React37.isValidElement(source[key]) || (0, import_react_is.isValidElementType)(source[key])) {
...
function useTheme2(defaultTheme4 = null) {
  const contextTheme = React38.useContext(ThemeContext);
...
function GlobalStyles2({
  ...
  return (0, import_jsx_runtime19.jsx)(GlobalStyles, {
    styles: globalStyles
  });
}
...
function createBox(options = {}) {
  ...
  const Box2 = React40.forwardRef(function Box3(inProps, ref) {
    ...
    return (0, import_jsx_runtime20.jsx)(BoxRoot, {
      as: component,
      ref,
...
var useEnhancedEffect = typeof window !== "undefined" ? React41.useLayoutEffect : React41.useEffect;
...
var elementAcceptingRef = chainPropTypes(import_prop_types15.default.element, acceptingRef);
...
var refType = import_prop_types17.default.oneOfType([import_prop_types17.default.func, import_prop_types17.default.object]);
...
function ThemeProvider(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(ThemeContext_default.Provider, {
    value: theme,
    children
  });
}
...
var PropsContext = React60.createContext(void 0);
...
function createContainer(options = {}) {
  ...
  const Container2 = React65.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime26.jsx)(ContainerRoot, {
        as: component,
        ownerState,
        className: clsx_default(classes.root, className),
        ref,
...
function isMuiElement2(element, muiNames) {
  var _a, _b, _c;
  return React66.isValidElement(element) && muiNames.indexOf(
...
function createGrid(options = {}) {
  ...
  const Grid2 = React67.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime27.jsx)(GridRoot, {
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ...
      children: React67.Children.map(children, (child) => {
        var _a;
        if (React67.isValidElement(child) && isMuiElement2(child, ["Grid"]) && container && child.props.container) {
...
function createStack(options = {}) {
  ...
  const Stack2 = React68.forwardRef(function Grid2(inProps, ref) {
    ...
    return (0, import_jsx_runtime28.jsx)(StackRoot, {
      as: component,
      ownerState,
      ref,
      className: clsx_default(classes.root, className),
...
var PickersFilledInput = React69.forwardRef(function PickersFilledInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersFilledInput"
  });
...
var PickersInput = React70.forwardRef(function PickersInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersInput"
  });
...
var PickersTextField = React71.forwardRef(function PickersTextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersTextField"
  });
  ...
  return (0, import_jsx_runtime31.jsxs)(PickersTextFieldRoot, _extends({
    className: clsx_default(classes.root, className),
    ref: handleRootRef,
    focused,
    onFocus,
    ...
    children: [(0, import_jsx_runtime31.jsx)(InputLabel_default, _extends({
      htmlFor: id,
      id: inputLabelId
    }, InputLabelProps, {
      children: label
    })), (0, import_jsx_runtime31.jsx)(PickersInputComponent, _extends({
      elements,
      areAllSectionsEmpty,
      onClick,
      onKeyDown,
    ...
    }, InputProps)), helperText && (0, import_jsx_runtime31.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
...
var DateField = React72.forwardRef(function DateField2(inProps, inRef) {
  const themeProps = useThemeProps({
    props: inProps,
    name: "MuiDateField"
  });
...
var useIsDateDisabled = ({
  ...
  const adapter = useLocalizationContext();
  return React73.useCallback((day) => validateDate({
    adapter,
    value: day,
    timezone,
    props: {
...
var PickersDayRaw = React76.forwardRef(function PickersDay(inProps, forwardedRef) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersDay"
  });
  ...
  if (outsideCurrentMonth && !showDaysOutsideCurrentMonth) {
    return (0, import_jsx_runtime34.jsx)(PickersDayFiller, {
      className: clsx_default(classes.root, classes.hiddenDaySpacingFiller, className),
      ownerState,
      role: other.role
    });
  }
  return (0, import_jsx_runtime34.jsx)(PickersDayRoot, _extends({
    className: clsx_default(classes.root, className),
    ref: handleRef,
    centerRipple: true,
    disabled,
...
true ? PickersDayRaw.propTypes = {
   ...
   * @default false
   */
  centerRipple: import_prop_types32.default.bool,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   * The date to show.
   */
  day: import_prop_types32.default.object.isRequired,
  /**
   ...
   * @default false
   */
  disableMargin: import_prop_types32.default.bool,
  /**
   ...
   * @default false
   */
  disableTouchRipple: import_prop_types32.default.bool,
  /**
   * If `true`, the base button will have a keyboard focus ripple.
   * @default false
   */
  focusRipple: import_prop_types32.default.bool,
  /**
  ...
  isAnimating: import_prop_types32.default.bool,
  /**
   * If `true`, day is the first visible cell of the month.
   * Either the first day of the month or the first day of the week depending on `showDaysOutsideCurrentMonth`.
   */
  isFirstVisibleCell: import_prop_types32.default.bool.isRequired,
  /**
   * If `true`, day is the last visible cell of the month.
   * Either the last day of the month or the last day of the week depending on `showDaysOutsideCurrentMonth`.
   */
  isLastVisibleCell: import_prop_types32.default.bool.isRequired,
  onBlur: import_prop_types32.default.func,
  onDaySelect: import_prop_types32.default.func.isRequired,
   ...
   */
  outsideCurrentMonth: import_prop_types32.default.bool.isRequired,
  /**
   ...
   * @default false
   */
  today: import_prop_types32.default.bool,
  /**
   * Props applied to the `TouchRipple` element.
   */
  TouchRippleProps: import_prop_types32.default.object,
  /**
   * A ref that points to the `TouchRipple` element.
   */
  touchRippleRef: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.shape({
    current: import_prop_types32.default.shape({
      pulsate: import_prop_types32.default.func.isRequired,
      start: import_prop_types32.default.func.isRequired,
      stop: import_prop_types32.default.func.isRequired
    })
  })])
} : void 0;
var PickersDay2 = React76.memo(PickersDayRaw);
...
function PickersSlideTransition(inProps) {
  ...
  return (0, import_jsx_runtime35.jsx)(PickersSlideTransitionRoot, {
    className: clsx_default(classes.root, className),
    childFactory: (element) => React77.cloneElement(element, {
      classNames: transitionClasses
    }),
    role: "presentation",
    children: (0, import_jsx_runtime35.jsx)(CSSTransition_default, _extends({
      mountOnEnter: true,
      unmountOnExit: true,
...
function WrappedDay(_ref) {
  ...
  const isDisabled = React78.useMemo(() => disabled || isDateDisabled(day), [disabled, isDateDisabled, day]);
  const outsideCurrentMonth = React78.useMemo(() => utils.getMonth(day) !== currentMonthNumber, [utils, day, currentMonthNumber]);
  const isFirstVisibleCell = React78.useMemo(() => {
  ...
  const isLastVisibleCell = React78.useMemo(() => {
  ...
  return (0, import_jsx_runtime36.jsx)(Day, _extends({}, dayProps, {
    day,
    disabled: isDisabled,
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React78.useMemo(() => selectedDays.filter((day) => !!day).map((day) => utils.startOfDay(day)), [utils, selectedDays]);
  const transitionKey = `${currentYearNumber}-${currentMonthNumber}`;
  const slideNodeRef = React78.useMemo(() => React78.createRef(), [transitionKey]);
  ...
  const weeksToDisplay = React78.useMemo(() => {
  ...
  return (0, import_jsx_runtime36.jsxs)(PickersCalendarDayRoot, {
    ...
    children: [(0, import_jsx_runtime36.jsxs)(PickersCalendarDayHeader, {
      ...
      children: [displayWeekNumber && (0, import_jsx_runtime36.jsx)(PickersCalendarWeekNumberLabel, {
        variant: "caption",
        role: "columnheader",
        "aria-label": translations.calendarWeekNumberHeaderLabel,
        className: classes.weekNumberLabel,
        children: translations.calendarWeekNumberHeaderText
      }), getWeekdays(utils, now).map((weekday, i) => (0, import_jsx_runtime36.jsx)(PickersCalendarWeekDayLabel, {
        variant: "caption",
        role: "columnheader",
    ...
    }), loading ? (0, import_jsx_runtime36.jsx)(PickersCalendarLoadingContainer, {
      className: classes.loadingContainer,
      children: renderLoading()
    }) : (0, import_jsx_runtime36.jsx)(PickersCalendarSlideTransition, _extends({
      ...
      children: (0, import_jsx_runtime36.jsx)(PickersCalendarWeekContainer, {
        ref: slideNodeRef,
        role: "rowgroup",
        ...
        children: weeksToDisplay.map((week, index) => (0, import_jsx_runtime36.jsxs)(PickersCalendarWeek, {
          ...
          children: [displayWeekNumber && (0, import_jsx_runtime36.jsx)(PickersCalendarWeekNumber, {
            className: classes.weekNumber,
            role: "rowheader",
            "aria-label": translations.calendarWeekNumberAriaLabelText(utils.getWeekNumber(week[0])),
            children: translations.calendarWeekNumberText(utils.getWeekNumber(week[0]))
          }), week.map((day, dayIndex) => (0, import_jsx_runtime36.jsx)(WrappedDay, {
            parentProps: props,
            day,
...
var PickersMonth = React79.memo(function PickersMonth2(inProps) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersMonth"
  });
  ...
  return (0, import_jsx_runtime37.jsx)(PickersMonthRoot, _extends({
    ...
    children: (0, import_jsx_runtime37.jsx)(MonthButton, _extends({}, monthButtonProps))
  }));
});
...
var MonthCalendar = React80.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React80.useMemo(() => utils.getMonth(now), [utils, now]);
  const selectedMonth = React80.useMemo(() => {
    if (value != null) {
      return utils.getMonth(value);
    }
    return null;
  }, [value, utils]);
  const [focusedMonth, setFocusedMonth] = React80.useState(() => selectedMonth || utils.getMonth(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "MonthCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isMonthDisabled = React80.useCallback((dateToValidate) => {
...
true ? MonthCalendar.propTypes = {
  ...
  gridLabelId: import_prop_types33.default.string,
  hasFocus: import_prop_types33.default.bool,
  /**
   * Maximal selectable date.
   * @default 2099-12-31
   */
  ...
  onFocusedViewChange: import_prop_types33.default.func,
  onMonthFocus: import_prop_types33.default.func,
  /**
...
var PickersYear = React81.memo(function PickersYear2(inProps) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersYear"
  });
  ...
  return (0, import_jsx_runtime39.jsx)(PickersYearRoot, _extends({
    ...
    children: (0, import_jsx_runtime39.jsx)(YearButton, _extends({}, yearButtonProps))
  }));
});
...
var YearCalendar = React82.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const isRtl = useRtl();
  const utils = useUtils();
  const referenceDate = React82.useMemo(
    () => singleItemValueManager.getInitialReferenceValue({
      value,
      utils,
      props,
  ...
  const todayYear = React82.useMemo(() => utils.getYear(now), [utils, now]);
  const selectedYear = React82.useMemo(() => {
    if (value != null) {
      return utils.getYear(value);
    }
    return null;
  }, [value, utils]);
  const [focusedYear, setFocusedYear] = React82.useState(() => selectedYear || utils.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isYearDisabled = React82.useCallback((dateToValidate) => {
  ...
  const scrollerRef = React82.useRef(null);
...
true ? YearCalendar.propTypes = {
  ...
  onYearFocus: import_prop_types34.default.func,
  /**
   * If `true` picker is readonly
   */
...
var PickersArrowSwitcher = React83.forwardRef(function PickersArrowSwitcher2(inProps, ref) {
  const isRtl = useRtl();
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersArrowSwitcher"
  ...
  return (0, import_jsx_runtime41.jsxs)(PickersArrowSwitcherRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: [(0, import_jsx_runtime41.jsx)(PreviousIconButton, _extends({}, previousIconButtonProps, {
      children: isRtl ? (0, import_jsx_runtime41.jsx)(RightArrowIcon, _extends({}, rightArrowIconProps)) : (0, import_jsx_runtime41.jsx)(LeftArrowIcon, _extends({}, leftArrowIconProps))
    })), children ? (0, import_jsx_runtime41.jsx)(Typography_default, {
      variant: "subtitle1",
      component: "span",
      id: labelId,
      children
    }) : (0, import_jsx_runtime41.jsx)(PickersArrowSwitcherSpacer, {
      className: classes.spacer,
      ownerState
    }), (0, import_jsx_runtime41.jsx)(NextIconButton, _extends({}, nextIconButtonProps, {
      children: isRtl ? (0, import_jsx_runtime41.jsx)(LeftArrowIcon, _extends({}, leftArrowIconProps)) : (0, import_jsx_runtime41.jsx)(RightArrowIcon, _extends({}, rightArrowIconProps))
    }))]
  }));
});
...
function useMeridiemMode(date, ampm, onChange, selectionState) {
  ...
  const handleMeridiemChange = React84.useCallback((mode) => {
...
var PickersCalendarHeader = React85.forwardRef(function PickersCalendarHeader2(inProps, ref) {
  const translations = usePickersTranslations();
  const utils = useUtils();
  const props = useThemeProps({
    props: inProps,
  ...
  return (0, import_jsx_runtime42.jsxs)(PickersCalendarHeaderRoot, _extends({}, other, {
    ...
    children: [(0, import_jsx_runtime42.jsxs)(PickersCalendarHeaderLabelContainer, {
      ...
      }), views.length > 1 && !disabled && (0, import_jsx_runtime42.jsx)(SwitchViewButton, _extends({}, switchViewButtonProps, {
...
true ? PickersCalendarHeader.propTypes = {
  ...
  currentMonth: import_prop_types35.default.object.isRequired,
  ...
  maxDate: import_prop_types35.default.object.isRequired,
  minDate: import_prop_types35.default.object.isRequired,
  onMonthChange: import_prop_types35.default.func.isRequired,
  onViewChange: import_prop_types35.default.func,
  reduceAnimations: import_prop_types35.default.bool.isRequired,
  /**
   * The props used for each component slot.
   * @default {}
   */
  ...
  timezone: import_prop_types35.default.string.isRequired,
  view: import_prop_types35.default.oneOf(["day", "month", "year"]).isRequired,
  views: import_prop_types35.default.arrayOf(import_prop_types35.default.oneOf(["day", "month", "year"]).isRequired).isRequired
} : void 0;
...
var DateCalendar = React86.forwardRef(function DateCalendar2(inProps, ref) {
  const utils = useUtils();
  const id = useId();
  ...
  const prevOpenViewRef = React86.useRef(view);
  React86.useEffect(() => {
  ...
  const selectedDays = React86.useMemo(() => [value], [value]);
  return (0, import_jsx_runtime43.jsxs)(DateCalendarRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: [(0, import_jsx_runtime43.jsx)(CalendarHeader, _extends({}, calendarHeaderProps, {
      slots,
      slotProps
    })), (0, import_jsx_runtime43.jsx)(DateCalendarViewTransitionContainer, {
      reduceAnimations,
...
true ? DateCalendar.propTypes = {
   ...
   */
  focusedView: import_prop_types36.default.oneOf(["day", "month", "year"]),
  /**
   ...
   */
  onFocusedViewChange: import_prop_types36.default.func,
  /**
   ...
   */
  openTo: import_prop_types36.default.oneOf(["day", "month", "year"]),
  /**
   ...
   * Must be a valid option from `views` list.
   */
  view: import_prop_types36.default.oneOf(["day", "month", "year"]),
  /**
   * Available views.
   */
  views: import_prop_types36.default.arrayOf(import_prop_types36.default.oneOf(["day", "month", "year"]).isRequired),
  /**
   * Years are displayed in ascending (chronological) order by default.
   * If `desc`, years are displayed in descending order.
   * @default 'asc'
...
// node_modules/@mui/x-date-pickers/DesktopDatePicker/DesktopDatePicker.js
var DesktopDatePicker = React88.forwardRef(function DesktopDatePicker2(inProps, ref) {
  var _a, _b;
  const translations = usePickersTranslations();
  const utils = useUtils();
...
var useMobilePicker = (_ref) => {
  ...
  const handleFieldRef = useForkRef(fieldRef, fieldProps.unstableFieldRef);
  const renderPicker = () => (0, import_jsx_runtime46.jsxs)(PickersProvider, {
    contextValue,
    localeText,
    children: [(0, import_jsx_runtime46.jsx)(Field, _extends({}, fieldProps, {
      ...
      slotProps,
      unstableFieldRef: handleFieldRef
    })), (0, import_jsx_runtime46.jsx)(PickersModalDialog, _extends({}, actions, {
      open,
      slots,
      slotProps,
...
// node_modules/@mui/x-date-pickers/MobileDatePicker/MobileDatePicker.js
var MobileDatePicker = React91.forwardRef(function MobileDatePicker2(inProps, ref) {
  var _a, _b;
  const translations = usePickersTranslations();
  const utils = useUtils();
...
MobileDatePicker.propTypes = {
   ...
   * Must be a valid option from `views` list.
   */
  openTo: import_prop_types38.default.oneOf(["day", "month", "year"]),
  /**
   * Force rendering in particular orientation.
   */
   ...
   * Must be a valid option from `views` list.
   */
  view: import_prop_types38.default.oneOf(["day", "month", "year"]),
  /**
   * Define custom view renderers for each section.
   * If `null`, the section will only have field editing.
   * If `undefined`, internally defined view will be used.
   ...
   * Available views.
   */
  views: import_prop_types38.default.arrayOf(import_prop_types38.default.oneOf(["day", "month", "year"]).isRequired),
  /**
   * Years are displayed in ascending (chronological) order by default.
   * If `desc`, years are displayed in descending order.
   * @default 'asc'
...
var DatePicker = React92.forwardRef(function DatePicker2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDatePicker"
  });
...
true ? DatePicker.propTypes = {
   ...
   * @default `true` for desktop, `false` for mobile (based on the chosen wrapper and `desktopModeMediaQuery` prop).
   */
  closeOnSelect: import_prop_types39.default.bool,
  /**
   * Formats the day of week displayed in the calendar header.
   * @param {TDate} date The date of the day of week provided by the adapter.
   * @returns {string} The name to display.
   ...
   */
  desktopModeMediaQuery: import_prop_types39.default.string,
  /**
   * If `true`, the picker and text field are disabled.
   * @default false
   */
   ...
   * @default false
   */
  disableOpenPicker: import_prop_types39.default.bool,
  /**
   * If `true`, disable values before the current date for date components, time for time components and both for date time components.
   * @default false
   */
   ...
   * @default false
   */
  enableAccessibleFieldDOMStructure: import_prop_types39.default.any,
  /**
   * The day view will show as many weeks as needed after the end of the current month to match this value.
   * Put it to 6 to have a fixed number of weeks in Gregorian calendars
   */
   ...
   * Must be a valid option from `views` list.
   */
  openTo: import_prop_types39.default.oneOf(["day", "month", "year"]),
  /**
   * Force rendering in particular orientation.
   */
   ...
   * If not provided, the selected sections will be handled internally.
   */
  selectedSections: import_prop_types39.default.oneOfType([import_prop_types39.default.oneOf(["all", "day", "empty", "hours", "meridiem", "minutes", "month", "seconds", "weekDay", "year"]), import_prop_types39.default.number]),
  /**
   * Disable specific date.
   *
   * Warning: This function can be called multiple times (for example when rendering date calendar, checking if focus can be moved to a certain date, etc.). Expensive computations can impact performance.
   ...
   * Must be a valid option from `views` list.
   */
  view: import_prop_types39.default.oneOf(["day", "month", "year"]),
  /**
   * Define custom view renderers for each section.
   * If `null`, the section will only have field editing.
   * If `undefined`, internally defined view will be used.
   ...
   * Available views.
   */
  views: import_prop_types39.default.arrayOf(import_prop_types39.default.oneOf(["day", "month", "year"]).isRequired),
  /**
   * Years are displayed in ascending (chronological) order by default.
   * If `desc`, years are displayed in descending order.
   * @default 'asc'
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VEOTELSD.js.map
